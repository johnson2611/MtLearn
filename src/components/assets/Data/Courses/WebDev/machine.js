  ...
  return (
    <div className="ty">
      ...
      <div className="container">
        ...
        <div>
          <li>
            Understanding the basics of Data Science and Machince Learning.
          </li>
          <li>
      ...
      {/* <div>
        {writeUp.map((writeUp) => (
          <div key={writeUp.id} className="writeup">
            <h2>{writeUp.title}</h2>
            <h2>{writeUp.content}</h2>
            <a href={writeUp.videoLink} target="_blank" rel='noopener noreferrer'>Watch video</a>
          </div>
        ))}
      </div> */}
    </div>
